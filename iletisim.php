            ...
            <footer id="footer">
                    ...
                    <form method="post" action="#">
                        <div class="fields">
                            ...
                            <div class="field">
                                ...
                                <input type="text" name="email" id="email" placeholder="Mailiniz..." />
                            </div>
                            <div class="field">
                                <label for="message">Mesaj</label>
                                <textarea name="message" id="message" rows="3" placeholder="Mesajınız..."></textarea>
                            </div>
                        </div>
                        <ul class="actions">
                            <!--TODO-->
                ...
                <section class="split contact">
                    <section>
                        <h3>TELEFON</h3>
                        <p><a href="tel:+905522801804">0552 280 18 04</a></p>
                    </section>
                    <section>
                        <h3>EMAIL</h3>
                        <p><a href="mailto:emretepeyazilim@gmail.com">emretepeyazilim@gmail.com</a></p>
                    </section>
                    <section>
                        <h3>SOSYAL MEDYA</h3>
                        <ul class="icons alt">
