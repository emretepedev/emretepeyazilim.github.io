...
import { required, alpha_dash, max, min, email, integer, oneOf, regex } from "vee-validate/dist/rules";
...
extend("alpha_dash", {
  ...alpha_dash,
  message: "The {_field_} must only contain letters, numbers, dashes and underscores."
});
