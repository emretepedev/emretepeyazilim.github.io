                            ...
                            <v-row>
                                <ValidationProvider
                                    ...
                                    :rules="{
                                        ...
                                        min_value: 0.000001,
                                        max_value:
                                            formatBalanceToDisplay(balance),
                                    }"
...
export default defineComponent({
    ...
    setup(_, { root }) {
        ...
        const handleTransactionReceipt = async () => {
            ...
            $vToastify.success(
                'Transaction Status: Awaiting block confirmation.'
            )
        ...
        const handleAccountsChanged = async (accounts) => {
            ...
            if (accounts.length > 0) {
                ...
                $vToastify.warning(
                    'Linked account not found. Page will be reloaded.'
                )
                location.reload()
            }
        }
